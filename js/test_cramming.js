const crammingTest = window.CAMPUS_PSYCH_TESTS.cramming;
const questions = crammingTest.questions;
...
function showResult() {
    ...
    const resultText = crammingTest.results[highest].text;

    document.getElementById("quiz-box").innerHTML = `
    <h2>당신의 유형은?</h2>
    <p id='result'>${resultText}</p>
    <div class="mt-4 text-center">
        <a href="${crammingTest.listUrl}" class="btn btn-outline-primary me-2">다른 테스트 하러 가기</a>
        <a href="${crammingTest.guideUrl}" class="btn btn-primary">유형별 해설 보기</a>
    </div>
`;
}
